...
angular.module('events')
    ...
    ["$scope", "$window", "$stateParams", "$location", "$filter", "Authentication", "Events", "EventSettings", function ($scope, $window, $stateParams, $location, $filter, Authentication, Events, EventSettings) {
